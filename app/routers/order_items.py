...
async def list_order_items(
    ...
    """
    order_items = crud_order_items.get_order_items(db, skip=skip, limit=limit)
    return order_items
...
async def get_order_item(
    ...
    """
    order_item = crud_order_items.get_order_item(db, order_item_id=order_item_id)
...
async def create_order_item(
    ...
    """
    return crud_order_items.create_order_item(db, order_item=order_item)
...
async def update_order_item(
    ...
    """
    order_item = crud_order_items.update_order_item(db, order_item_id=order_item_id, order_item_update=order_item_update)
    if order_item is None:
        raise HTTPException(
            status_code=status.HTTP_404_NOT_FOUND,
            detail="Order item not found"
...
async def delete_order_item(
    ...
    """
    order_item = crud_order_items.delete_order_item(db, order_item_id=order_item_id)
    if order_item is None:
        raise HTTPException(
            status_code=status.HTTP_404_NOT_FOUND,
            detail="Order item not found"
